...
const PET_META = {
  ...
  cancer:       { face: 'right', key: 'cancer',       name: '巨蟹',   emoji: '🐹', img: '/assets/pets/cancer.png',       read: '/assets/pets/cancer-read.png',       scene: '/assets/pets/cancer-scene.png',       animal: '仓鼠',   color: '#ffb74d', tone: '黏人细心、爱操心，像仓鼠一样把你的小事都记在心里' },
  leo:          { face: 'right', key: 'leo',          name: '狮子',   emoji: '🦁', img: '/assets/pets/leo.png',          read: '/assets/pets/leo-read.png',          scene: '/assets/pets/leo-scene.png',          animal: '狮子',   color: '#f39c12', tone: '自信霸气、有领导力，爱夸你，像狮子一样护着你' },
  virgo:        { face: 'right', key: 'virgo',       name: '处女',   emoji: '🦉', img: '/assets/pets/virgo.png',        read: '/assets/pets/virgo-read.png',        scene: '/assets/pets/virgo-scene.png',        animal: '猫头鹰', color: '#607d8b', tone: '认真细致、爱提醒细节，温和但较真，像猫头鹰一样敏锐' },
  libra:        { face: 'left', key: 'libra',        name: '天秤',   emoji: '🦢', img: '/assets/pets/libra.png',        read: '/assets/pets/libra-read.png',        scene: '/assets/pets/libra-scene.png',        animal: '天鹅',   color: '#e91e63', tone: '优雅平和、爱平衡，会帮你理清取舍，像天鹅一样从容' },
  scorpio:      { face: 'right', key: 'scorpio',      name: '天蝎',   emoji: '🐈', img: '/assets/pets/scorpio.png',      read: '/assets/pets/scorpio-read.png',      scene: '/assets/pets/scorpio-scene.png',      animal: '黑猫',   color: '#2c3e50', tone: '神秘深沉、话少但准，有点小傲娇，像黑猫一样难以捉摸' },
  sagittarius:  { face: 'left', key: 'sagittarius',  name: '射手',   emoji: '🐺', img: '/assets/pets/sagittarius.png',  read: '/assets/pets/sagittarius-read.png',  scene: '/assets/pets/sagittarius-scene.png',  animal: '哈士奇', color: '#3498db', tone: '自由奔放、爱冒险、跳脱，像哈士奇一样停不下来' },
  capricorn:    { face: 'right', key: 'capricorn',    name: '摩羯',   emoji: '🐢', img: '/assets/pets/capricorn.png',    read: '/assets/pets/capricorn-read.png',    scene: '/assets/pets/capricorn-scene.png',    animal: '乌龟',   color: '#795548', tone: '踏实稳重、慢热靠谱，默默陪你，像乌龟一样坚持' },
  aquarius:     { face: 'right', key: 'aquarius',     name: '水瓶',   emoji: '🦆', img: '/assets/pets/aquarius.png',     read: '/assets/pets/aquarius-read.png',     scene: '/assets/pets/aquarius-scene.png',     animal: '鸭嘴兽', color: '#00bcd4', tone: '古怪有趣、脑洞清奇、不按常理，像鸭嘴兽一样独特' },
  pisces:       { face: 'left', key: 'pisces',       name: '双鱼',   emoji: '🐰', img: '/assets/pets/pisces.png',       read: '/assets/pets/pisces-read.png',       scene: '/assets/pets/pisces-scene.png',       animal: '兔子',   color: '#ff80ab', tone: '温柔敏感、爱做梦、共情强，像兔子一样柔软贴心' }
};
