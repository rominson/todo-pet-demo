...
const PET_META = {
  ...
  aries:        { face: 'left', key: 'aries',        name: '白羊',   emoji: '🐶', img: '/assets/pets/aries.png',        read: '/assets/pets/aries-read.png',        scene: '/assets/pets/aries-scene.png',        anim: ANIM_CDN + 'aries-read.gif',        animal: '金毛',   color: '#ff6b6b', tone: '热情直率、爱鼓励人，像只摇尾巴的金毛，永远给你打气' },
  ...
  cancer:       { face: 'left', key: 'cancer',       name: '巨蟹',   emoji: '🐹', img: '/assets/pets/cancer.png',       read: '/assets/pets/cancer-read.png',       scene: '/assets/pets/cancer-scene.png',       anim: ANIM_CDN + 'cancer-read.gif',       animal: '仓鼠',   color: '#ffb74d', tone: '黏人细心、爱操心，像仓鼠一样把你的小事都记在心里' },
  ...
  virgo:        { face: 'left', key: 'virgo',       name: '处女',   emoji: '🦉', img: '/assets/pets/virgo.png',        read: '/assets/pets/virgo-read.png',        scene: '/assets/pets/virgo-scene.png',        anim: ANIM_CDN + 'virgo-read.gif',        animal: '猫头鹰', color: '#607d8b', tone: '认真细致、爱提醒细节，温和但较真，像猫头鹰一样敏锐' },
  libra:        { face: 'right', key: 'libra',        name: '天秤',   emoji: '🦢', img: '/assets/pets/libra.png',        read: '/assets/pets/libra-read.png',        scene: '/assets/pets/libra-scene.png',        anim: ANIM_CDN + 'libra-read.gif',        animal: '天鹅',   color: '#e91e63', tone: '优雅平和、爱平衡，会帮你理清取舍，像天鹅一样从容' },
  scorpio:      { face: 'left', key: 'scorpio',      name: '天蝎',   emoji: '🐈', img: '/assets/pets/scorpio.png',      read: '/assets/pets/scorpio-read.png',      scene: '/assets/pets/scorpio-scene.png',      anim: ANIM_CDN + 'scorpio-read.gif',      animal: '黑猫',   color: '#2c3e50', tone: '神秘深沉、话少但准，有点小傲娇，像黑猫一样难以捉摸' },
